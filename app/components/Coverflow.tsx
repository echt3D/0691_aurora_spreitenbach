  ...
  return (
    <section className="w-full flex flex-col items-center">
      <div className="relative w-full">
        <button
          className="absolute top-1/2 left-0   xl:left-16 transform -translate-y-1/2 z-10 cursor-pointer"
          onClick={() => handlePrev()}
        >
          <Image src="/icons/arrow.svg" width="20" height="20" alt="arrow" />
        </button>
        <div
          className="coverflow flex justify-center p-2"
        ...
        <button
          className="absolute top-1/2 right-0  xl:right-16 transform -translate-y-1/2 cursor-pointer"
          onClick={() => handleNext()}
        >
          <Image
            src="/icons/arrow.svg"
